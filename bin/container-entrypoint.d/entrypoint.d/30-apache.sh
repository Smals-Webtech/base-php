...
APACHE_LOG_FORMAT_COMBINED_DEFAULT="%h %l %u %t \\\"%r\\\" %>s %b \\\"%{Referer}i\\\" \\\"%{User-Agent}i\\\""
APACHE_LOG_FORMAT_COMMON_DEFAULT="%h %l %u %t \\\"%r\\\" %>s %b"

export APACHE_LOG_FORMAT_COMBINED=${APACHE_LOG_FORMAT_COMBINED:-"${APACHE_LOG_FORMAT_COMBINED_DEFAULT}"}
export APACHE_LOG_FORMAT_COMMON=${APACHE_LOG_FORMAT_COMMON:-"${APACHE_LOG_FORMAT_COMMON_DEFAULT}"}
