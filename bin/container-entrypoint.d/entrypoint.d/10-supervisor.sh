...
SUPERVISOR_XMLRPC_UNIX_SOCKET_ENABLED_DEFAULT="true"
SUPERVISOR_XMLRPC_UNIX_SOCKET_PATH_DEFAULT="/app/var/run/supervisor.sock"
SUPERVISOR_XMLRPC_UNIX_SOCKET_CHMOD_DEFAULT="0700"
SUPERVISOR_XMLRPC_UNIX_SOCKET_CHOWN_DEFAULT="default:root"
SUPERVISOR_XMLRPC_UNIX_SOCKET_AUTH_ENABLED_DEFAULT="true"
SUPERVISOR_XMLRPC_UNIX_SOCKET_USERNAME_DEFAULT="admin"
SUPERVISOR_XMLRPC_UNIX_SOCKET_PASSWORD_DEFAULT="pa55w0rd"

SUPERVISOR_XMLRPC_INET_ENABLED_DEFAULT="false"
...
export SUPERVISOR_XMLRPC_UNIX_SOCKET_ENABLED=${SUPERVISOR_XMLRPC_UNIX_SOCKET_ENABLED:-"${SUPERVISOR_XMLRPC_UNIX_SOCKET_ENABLED_DEFAULT}"}
...
export SUPERVISOR_XMLRPC_UNIX_SOCKET_AUTH_ENABLED=${SUPERVISOR_XMLRPC_UNIX_SOCKET_AUTH_ENABLED:-"${SUPERVISOR_XMLRPC_UNIX_SOCKET_AUTH_ENABLED_DEFAULT}"}
export SUPERVISOR_XMLRPC_UNIX_SOCKET_USERNAME=${SUPERVISOR_XMLRPC_UNIX_SOCKET_USERNAME:-"${SUPERVISOR_XMLRPC_UNIX_SOCKET_USERNAME_DEFAULT}"}
export SUPERVISOR_XMLRPC_UNIX_SOCKET_PASSWORD=${SUPERVISOR_XMLRPC_UNIX_SOCKET_PASSWORD:-"${SUPERVISOR_XMLRPC_UNIX_SOCKET_PASSWORD_DEFAULT}"}

export SUPERVISOR_XMLRPC_INET_ENABLED=${SUPERVISOR_XMLRPC_INET_ENABLED:-"${SUPERVISOR_XMLRPC_INET_ENABLED_DEFAULT}"}
